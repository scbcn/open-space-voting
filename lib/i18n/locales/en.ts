export const en = {
  accessForm: {
    ...
    error: "Error",
    errorDescription: "There was an error setting up the Open Space. Please try again later.",
    wrongOpenSpaceId: "The Open Space ID is incorrect, please ask the organizer for the correct ID",
  ...
  welcome: {
    ...
    joinUs: "Join us in this unique collaborative learning and networking experience.",
  ...
  footer: {
    appDescription: "An application to manage Open Spaces, developed by the Software Crafters Barcelona community.",
    links: {
    ...
    copyright: "© 2025 Software Crafters Barcelona. All rights reserved."
  },
  proposePage: {
    title: "Propose a Topic",
    proposalsClosed: "Proposals Closed",
    proposalsClosedDescription: "Topic proposals are temporarily closed by the administrator.",
  ...
  votePage: {
    ...
    votingClosedDescription: "Topic voting is temporarily closed by the administrator."
  },
  themeCard: {
    votes: "votes",
    vote: "Vote",
  ...
  sessionPage: {
    notFound: {
      ...
      description: "The session you are looking for doesn't exist or has been removed.",
